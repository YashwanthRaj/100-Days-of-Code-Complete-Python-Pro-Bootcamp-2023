...
# Creating a list to add already guessed letters    
guessed_letters =[]
...
while blank_bool:
    ...
    # Notifying if the letter already guessed
    if guess in guessed_letters:
        print("Already guessed the letter " + guess+ " !! Please try again. ")
        continue
    
    # Check if choosen guess is in the word
    if guess not in chosen_word:
        print("You have entered a letter that is not in word. You loose a life :(")
        lives-=1
    else:
        print("You have entered correct!! Keep Going.")
